...
vector<CellVec> RyuJonesPIP = {{1.08*rho_SF, 1.2*sqrt(p_SF)/sqrt(rho_SF), 0.01*sqrt(p_SF)/sqrt(rho_SF), 0.5*sqrt(p_SF)/sqrt(rho_SF), 0.95*p_SF, 0.564190*sqrt(p_SF), 1.015541*sqrt(p_SF), 0.564190*sqrt(p_SF), 0, 0, 0, 0}, {0.9891*rho_SF, -0.0131*sqrt(p_SF)/sqrt(rho_SF), 0.0269*sqrt(p_SF)/sqrt(rho_SF), 0.010037*sqrt(p_SF)/sqrt(rho_SF), 0.97159*p_SF, 0.564190*sqrt(p_SF), 1.135262*sqrt(p_SF), 0.564923*sqrt(p_SF), 0, 0, 0, 0}};
